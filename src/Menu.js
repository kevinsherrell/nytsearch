            ...
            <div className='overlay'>
                <header>
                    <div className="menuHeaderContainer container">
                        <div className='menuHeaderLeft'></div>
                        <div className='menuHeaderCenter'><img className='logoMain' src={logo} alt="" /></div>
                        <div className='menuHeaderRight'><img className="closeIcon" src={close} alt="" /></div>
                    </div>
                </header>
